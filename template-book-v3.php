...
<div id="demo" class="carousel slide" data-ride="carousel"> 
	...
	<div class="checkoutForm">
		...
		<h4>Payment Details</h4>
				...
				<input type="checkbox" id="accept" name="accept"  value="true" required /><p>I agree to the <a href="<?php echo site_url(); ?>/terms-conditions/">terms & conditions</a></p> 
				</div>
