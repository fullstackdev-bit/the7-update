<?php
/* Template Name: Property Detail-2 */
/**
						  ...
						  <Quotes>
							<Quote>
							  <QuoteItem>
								...
								$xml.='<ChargeTypeId>2</ChargeTypeId>';
								}else{
...
<div id="content" class="content gaba" role="main">
    ...
    <tbody>
      <tr>
		...
		<td data-title="Noofnights"><?php echo $nights = (strtotime($_GET['D']) - strtotime($_GET['A'])) / 86400; ?></td>
...
<aside id="sidebar" class="sidebar">
	<div class="sidebar-content">
		<section id="search-2" class="widget widget_search"> 
			...
			<div class="card">
				<h5 class="card-header info-color white-text text-center py-4"> <strong> Check Availability</strong> </h5>
				<!--Card content-->
