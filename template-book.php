...
<div id="demo" class="carousel slide" data-ride="carousel"> 
		...
		<table class="table">
			...
			<tbody>
				<tr>
					...
					<td data-title="Price"><?php echo $_SESSION['bookingDetail']['TotalPrice'];?> AUD</td>
					<td data-title="Price"><?php echo $_SESSION['bookingDetail']['TotalDeposit'];?> AUD</td>
	...
	<div class="checkoutForm">
		...
		<h4>Payment Details</h4>
				...
				<!--
				<div class="md-form full mt-3">
				<input type="checkbox" name="accept" class="form-control" value="true" required /> I accept it.<br />
				</div>
				--->
				<!-- Send button -->
