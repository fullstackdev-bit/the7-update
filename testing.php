...
<div id="content" class="content" role="main"> 
	...
	<div class="ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-active ui-accordion-content-first" id="ui-id-2" aria-labelledby="ui-id-1" role="tabpanel" aria-hidden="false" style="display: block;">
		<form name="RMS Booking Form" name="rms-booking" id="rms-booking" method="GET" action="https://executiveescapes.com.au/search/" style="float: left;width: 100%;clear: both;">
...
<!-- start -->
								...
								<div class="vc_col-sm-12 vc_col-lg-3 vc_col-md-3 input arrival">
									...
									<span class="calendar-icon">
										<input autocomplete="off" class="dateRange arrival-date-nw-1" type="text" name="A" placeholder="Arrival" required=""  value="">
									</span>
                                    <h4 class="hme-note">*Minimum 3 nights allowed to book</h4>
								</div>
								<div class="vc_col-sm-12 vc_col-lg-3 vc_col-md-3 input departure">
									...
									<span class="calendar-icon">
										<input autocomplete="off" class="dateRange departure-date-nw-1" type="text" name="D" placeholder="Departure" required=""  value="">
									</span>
								</div>
<!-- end -->


								<div class=" vc_col-sm-12 vc_col-lg-6 vc_col-md-6 gbu">
								<div class=" adults vc_col-sm-12 vc_col-lg-4 vc_col-md-4">
									<label>
										<span>Adult(s)</span>
									</label>
...
<!--
		 		...
		 		<div class="dt-fancy-separator h1-size style-disabled accent-title-color" style="width: 100%; "><div class="dt-fancy-title"><span class="separator-holder separator-left"></span>FEATURED PROPERTIES<span class="separator-holder separator-right"></span></div></div>
...
if (in_array("feature", $final_attributes)){
