									...
									// echo "BookingRangeAvailable====>>>>".$singleRoomPoperty['BookingRangeAvailable']; 
									  ...
									  //****************************								
												...
												if($err_new){
													...
													$p_name=strtolower($final_result['Name']);
		...
		<div class="visible wf-cell vc_col-xs-12 property_attribute" data-search=1 data-name="<?php echo $final_result['Name']; ?>" data-attributes="<?php echo $final_attributes; ?>">
			...
			<article class="post visible dt_portfolio type-dt_portfolio status-publish">
				...
				<div class="post-thumbnail-wrap  ">
					...
					<div class="post-thumbnail"> <a href="<?php echo home_url(); ?>/details/<?php echo $p_name; ?>/?id=<?php echo $final_result['RoomTypeId'];?>&A=<?php echo $arrival; ?>&D=<?php echo $departure; ?>&Ad=<?php echo $adults  ?>&C=<?php echo $children; ?>" class="post-thumbnail-rollover" target="">
				...
				<div class="post-entry-content new">
					...
					<h3 class="entry-title"> <a href="<?php echo home_url(); ?>/details/<?php echo $p_name; ?>/?id=<?php echo $final_result['RoomTypeId'];?>&A=<?php echo $arrival; ?>&D=<?php echo $departure; ?>&Ad=<?php echo $adults  ?>&C=<?php echo $children; ?>" target="" title="Woodlands Retreat" rel="bookmark"><?php echo $final_result['Name']; ?></a> </h3>
...
<?php 
	...
	?>
					...
					<a class="btn btn-outline-info btn-rounded z-depth-0 waves-effect" href="<?php echo home_url(); ?>/details/<?php echo $p_name; ?>/?id=<?php echo $final_result['RoomTypeId'];?>&A=<?php echo $arrival; ?>&D=<?php echo $departure; ?>&Ad=<?php echo $adults  ?>&C=<?php echo $children; ?>"  target="">Book Now</a></div> </div>
